...
const Occupations = () => {
  ...
  const [formRecord, setFormRecord] = useState<FormRecord<Occupation>>({
    record: null,
    isCreate: true,
    loading: false,
    showModal: false,
  ...
  const [deleteRecord, setDeleteRecord] = useState<DeleteRecord<Occupation>>({
    record: null,
    loading: false,
    showModal: false,
  });
  ...
  const handleEditRecord = (values: Occupation) => {
  ...
  const onSubmit = (values: OccupationForm) => {
  ...
  const handleDelete = (record: Occupation) => {
  ...
  const columns = [
    {
      ...
      dataIndex: "s_no",
      key: "s_no",
      render: (value: string, record: Occupation, index: number) => {
    ...
    },
    {
      ...
      dataIndex: "action",
      key: "action",
      render: (value: string, record: Occupation) => {
        return (
        ...
        <div className="flex flex-col gap-4">
          ...
          <Dialog isOpen={formRecord.showModal} onClose={handleCloseForm}>
            <h4 className="mb-4 text-center">
              {formRecord.isCreate ? "Create Occupation" : "Update Occupation"}
            </h4>
