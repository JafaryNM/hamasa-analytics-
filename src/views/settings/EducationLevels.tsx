...
const EducationLevels = () => {
  ...
  const [formRecord, setFormRecord] = useState<FormRecord<EducationLevel>>({
    record: null,
    isCreate: true,
    loading: false,
    showModal: false,
  ...
  const handleEditRecord = (values: EducationLevel) => {
  ...
  const onSubmit = (values: EducationLevelForm) => {
  ...
  const handleDelete = (record: EducationLevel) => {
  ...
  const columns = [
    {
      ...
      dataIndex: "s_no",
      key: "s_no",
      render: (value: string, record: EducationLevel, index: number) => {
    ...
    },
    {
      ...
      dataIndex: "action",
      key: "action",
      render: (value: string, record: EducationLevel) => {
        return (
