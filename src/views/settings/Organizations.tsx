...
const Organizations = () => {
  ...
  const [formRecord, setFormRecord] = useState<FormRecord<Organization>>({
    record: null,
    isCreate: true,
    loading: false,
    showModal: false,
  ...
  const [deleteRecord, setDeleteRecord] = useState<DeleteRecord<Organization>>({
    record: null,
    loading: false,
    showModal: false,
  });
  ...
  const handleEditRecord = (values: Organization) => {
  ...
  const columns = [
    {
      ...
      dataIndex: "s_no",
      key: "s_no",
      render: (value: string, record: Organization, index: number) => {
