...
import { ExpertiseForm, ExpertiseSchema } from "../../schemas/ExpertiseSchema";
...
const Expertises = () => {
  ...
  const [formRecord, setFormRecord] = useState<FormRecord<Expertise>>({
    record: null,
    isCreate: true,
    loading: false,
    showModal: false,
  ...
  const [deleteRecord, setDeleteRecord] = useState<DeleteRecord<Expertise>>({
    record: null,
    loading: false,
    showModal: false,
  });
  ...
  const handleEditRecord = (values: Expertise) => {
  ...
  const onSubmit = (values: ExpertiseForm) => {
  ...
  const handleDelete = (record: Expertise) => {
  ...
  const columns = [
    {
      ...
      dataIndex: "s_no",
      key: "s_no",
      render: (value: string, record: Expertise, index: number) => {
    ...
    },
    {
      ...
      dataIndex: "action",
      key: "action",
      render: (value: string, record: Expertise) => {
        return (
        ...
        <div className="flex flex-col gap-4">
          ...
          <Dialog isOpen={formRecord.showModal} onClose={handleCloseForm}>
            <h4 className="mb-4 text-center">
              {formRecord.isCreate ? "Create Expertise" : "Update Expertise"}
            </h4>
