...
import useJournalistUsers from "@/hooks/useJournalistUsers";
...
import { JudgeForm, JudgeSchema } from "../../schemas/JudgeSchema";
...
const Journalists = () => {
  ...
  const [formRecord, setFormRecord] = useState<FormRecord<Judge>>({
    record: null,
    isCreate: true,
    loading: false,
    showModal: false,
  ...
  const onSubmit = (values: JudgeForm) => {
  ...
  const columns = [
    {
      ...
      dataIndex: "s_no",
      key: "s_no",
      render: (value: string, record: Judge, index: number) => {
    ...
    },
    {
      ...
      dataIndex: "fullName",
      key: "fullName",
      render: (value: string, record: Judge) =>
          ...
          <div className="flex gap-3">
            <Tooltip wrapperClass="flex" title="View">
              <span
                ...
                onClick={() =>
                  navigate(
                    `/user-management/journalists/details/${record.uuid}`
                  )
                }
              >
                <TbEye size={20} />
        ...
        <div className="flex flex-col gap-4">
          ...
          <Dialog isOpen={formRecord.showModal} onClose={handleCloseForm}>
            <h4 className="mb-4 text-center">
              {formRecord.isCreate ? "Create Judge" : "Update Judge"}
            </h4>
