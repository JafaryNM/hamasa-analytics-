...
import WorkingPortfolio from "./components/WorkPortifolio";
import { Button, Card } from "@/components/ui";

const JournalistAccountMain: React.FC = () => {
  const { user } = useAuth();
  ...
  const getJournalistDetails = async (uuid: string) => {
    ...
    try {
      ...
      methods.reset({
        ...
        profilePicture: journalist.profilePicUrl,
...
export default JournalistAccountMain;
